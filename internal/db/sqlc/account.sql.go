...
INSERT INTO accounts (
    ...
    $1, $2, $3
) RETURNING id, email, hashed_password, user_id, status, created_at, updated_at
`
...
SELECT id, email, hashed_password, user_id, status, created_at, updated_at FROM accounts
